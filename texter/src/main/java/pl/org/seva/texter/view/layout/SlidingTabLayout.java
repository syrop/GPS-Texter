 ...
 * <p>
 * The colors can be customized in two ways. (...) The
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private TextView createDefaultTabView(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            textView.setTextColor(getResources().getColorStateList(R.color.selector, context.getTheme()));
        }
        else {
    ...
    private void populateTabStrip() {
        ...
        final View.OnClickListener tabClickListener = this::onTabClicked;
    ...
    private void onTabClicked(View v) {
        for (int i = 0; i < mTabStrip.getChildCount(); i++) {
